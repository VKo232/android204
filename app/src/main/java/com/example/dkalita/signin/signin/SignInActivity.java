...
import com.example.dkalita.iisweb.CustomerActivity;
...
//		Intent myIntent = new Intent(this, SuccessActivity.class);
		...
		try {
			CustomerObj customerObj = signInModel.getCustomerObj();
			if (customerObj != null) {
				...
				ArrayList<AccountObj> accountObjList = signInModel.getAccountObjList();
